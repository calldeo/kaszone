<div class="deznav">
	<div class="deznav-scroll">
		<div class="main-profile">
			<div class="image-bx">
				<img src="{{ asset ('dash/images/mamo.jpeg') }}" alt="">
				{{-- <a href="javascript:void(0);"><i class="fa fa-cog" aria-hidden="true"></i></a> --}}
			</div>
			<h5 class="name"><span class="font-w400">Hello,</span>{{auth()->user()->name}}</h5>
			<p class="email"><a href="" class="_cf_email_" data-cfemail="95f8f4e7e4e0f0efefefefd5f8f4fcf9bbf6faf8">{{auth()->user()->email}}</a></p>
		</div>
