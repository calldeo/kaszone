                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control default-select" id="sel1" name="kelamin" required>
                                ...
                                <option value="laki-laki" {{ old('kelamin', $admin->kelamin) == 'laki-laki' ? 'selected' : '' }}>Laki-Laki</option>
                                <option value="perempuan" {{ old('kelamin', $admin->kelamin) == 'perempuan' ? 'selected' : '' }}>Perempuan</option>
                            </select>
                        </div>
