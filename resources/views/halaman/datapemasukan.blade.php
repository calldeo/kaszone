...
<a href="/add_pemasukan" class="btn btn-warning mr-1" title="Add">
    <i class="fa fa-plus"></i>
</a>
@endhasrole

@hasrole('Admin|Bendahara')
<a href="/cetak-pemasukan" target="_blank" class="btn btn-info ml-0 mr-1" title="Print Report">
    <i class="fa fa-print"></i>
</a>
@endhasrole

@hasrole('Admin|Bendahara')
<a href="{{ url('/export-pemasukan') }}" class="btn btn-success ml-0 mr-1" title="Export to Excel">
    <i class="fa fa-file"></i>
</a>
@endhasrole

@hasrole('Admin|Bendahara')
<button type="button" class="btn btn-primary mr-0" data-toggle="modal" data-target="#importModal">
